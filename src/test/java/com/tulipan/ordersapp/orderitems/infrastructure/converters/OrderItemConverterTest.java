...
class OrderItemConverterTest {
    ...
    private static OrderItem createOrderItem() {
        ...
        item.setOrder(new Order(1L, LocalDateTime.now(), new BigDecimal(10), null, BigDecimal.ZERO));
        item.setProduct("Product Full Description");
    ...
    private OrderItemEntity createOrderItemEntity() {
        ...
        entity.setOrder(new OrderEntity(1L, LocalDateTime.now(), new BigDecimal(10), null, BigDecimal.ZERO));
        ...
        entity.setProduct("Product Full Description");
        return entity;
    }
    ...
    private void assertEntityToModelMapping(OrderItemEntity entity, OrderItem item) {
        ...
        assertEquals(entity.getProduct(), item.getProduct());
    ...
    private void assertModelToEntityMapping(OrderItem item, OrderItemEntity entity) {
        ...
        assertEquals(item.getProduct(), entity.getProduct());
